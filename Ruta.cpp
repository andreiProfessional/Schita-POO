...
std::string Ruta::gasireNumeStatie(const int &pozitie) {
    return statii[pozitie]->gasireNumeStatie();
}

std::string Ruta::gasireNumeStatieUrmatoare(const bool &catreDus, const int &pozitie) {
    if (catreDus) {
